...
const Events = () => {
  ...
  const confirmEnrollment = () => {
    // Handle enrollment logic here (e.g., mark event as enrolled)
    alert("Event enrolled successfully!");
    // Prevent the enroll button from showing again
    // You can implement this logic as per your application's data structure
    setShowPopup(false);
  };
      ...
      {showPopup && (
        <div className={styles.popup}>
          <div className={styles.popupContent}>
            <p>Do you want to enroll in this event?</p>
